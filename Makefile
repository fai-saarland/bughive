...
all: asnets asnets-bin pheromone fd-action-policy-testing fd-action-policy-testing-debug dynet eigen
...
eigen-3.4.0/INSTALL: eigen-3.4.0.zip
	unzip -n eigen-3.4.0.zip
	touch eigen-3.4.0/INSTALL
eigen-master/INSTALL: eigen-master.zip # currently used eigen commit: c29c800126982c561e8d0b9255dc65474cd98de3
	unzip -n eigen-master.zip
	touch eigen-master/INSTALL
