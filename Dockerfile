...
RUN pip install termcolor torch pytorch_lightning tarski grpcio protobuf
...
RUN cd /docker && git clone --depth 1 https://github.com/fai-saarland/bughive.git && cd bughive && git submodule update --depth 1 --init
