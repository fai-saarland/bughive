(define
  ...
  (:init
		...
		(ready-to-unload part07)
		(next-to-unload part07 part10)
		(next-to-unload part10 part08)
		(next-to-unload part08 part09)
		(next-to-unload part09 part05)
		(next-to-unload part05 part03)
		(next-to-unload part03 part01)
		(next-to-unload part01 part04)
		(next-to-unload part04 part02)
		(next-to-unload part02 part06)
		(next-to-unload part06 nonep)
		(no-rack-succ part01)
		(no-rack-pre part01)
		(no-rack-succ part02)
		(no-rack-pre part02)
		...
		(unused rack5)
		(needed-next nonep)
		(p-line-next plA part09)
		(p-line-succ part09 part08)
		(p-line-succ part08 part02)
		(p-line-succ part02 part04)
		(p-line-succ part04 part01)
		(p-line-succ part01 part10)
		(p-line-succ part10 part07)
		(p-line-succ part07 part06)
		(p-line-succ part06 part03)
		(p-line-succ part03 part05)
		(p-line-succ part05 nonep)
