(define
  ...
  (:init
		...
		(ready-to-unload part03)
		(next-to-unload part03 part07)
		(next-to-unload part07 part04)
		(next-to-unload part04 part11)
		(next-to-unload part11 part02)
		(next-to-unload part02 part06)
		(next-to-unload part06 part08)
		(next-to-unload part08 part10)
		(next-to-unload part10 part05)
		(next-to-unload part05 part09)
		(next-to-unload part09 part01)
		...
		(unused rack5)
		(needed-next nonep)
		(p-line-next plA part03)
		(p-line-succ part03 part05)
		(p-line-succ part05 part11)
		(p-line-succ part11 part10)
		(p-line-succ part10 part09)
		(p-line-succ part09 part02)
		(p-line-succ part02 part08)
		(p-line-succ part08 part01)
		(p-line-succ part01 part04)
		(p-line-succ part04 part07)
		(p-line-succ part07 part06)
		(p-line-succ part06 nonep)
