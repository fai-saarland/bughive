(define
  ...
  (:init
		...
		(unused rack5)
		(needed-next nonep)
		(p-line-next plA part6)
		(p-line-succ part6 part8)
		(p-line-succ part8 part2)
		(p-line-succ part2 part5)
		(p-line-succ part5 part4)
		(p-line-succ part4 part1)
		(p-line-succ part1 part3)
		(p-line-succ part3 part7)
		(p-line-succ part7 nonep)
